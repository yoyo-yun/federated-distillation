...
teacher_model_1 = torch.load("./Euadr_model/center_model_albert.pkl", map_location=teacher_device)
teacher_model_2 = torch.load("./Euadr_model/center_model_scibert.pkl", map_location=teacher_device)
teacher_model_3 = torch.load("./Euadr_model/center_model_Bio-renet.pkl", map_location=teacher_device)
...
for epoch in range(epochs):
    ...
    print("{Stacking :" + teacher_model_name + "}")
