...
teacher_model_name_1='albert_'
teacher_model_name_2='scibert_'
teacher_model_name_3='PubMedBERT_'
teacher_model_1 = torch.load("./Euadr_model/center_model_scibert.pkl", map_location=teacher_device)
# teacher_model_2 = torch.load("./GAD_model/center_model_scibert.pkl", map_location=teacher_device)
teacher_model_3 = torch.load("./Euadr_model/center_model_biobert.pkl", map_location=teacher_device)
...
for epoch in range(epochs):
    ...
    if best_f1 < avg_val_f1:
        ...
        torch.save(model, './distill_center/distill_center_model_' + teacher_model_name + '.pkl')
        torch.save(model.state_dict(), './distill_center/distill_center_model_' + teacher_model_name + '.pth')
