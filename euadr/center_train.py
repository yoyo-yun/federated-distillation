...
print("Train set length is " + str(len(res_train)))
...
# loadData val
# pd3 = pd.read_csv("./shuffleDatasets/data_7.csv")
...
print("Test set length is " + str(len(res_test)))
...
for epoch in range(epochs):
    ...
    if best_f1 < avg_val_f1:
        ...
        torch.save(model.state_dict(), './Euadr_model/center_model_' + repo_model_name + '.pth')
        torch.save(model, './Euadr_model/center_model_' + repo_model_name + '.pkl')
    print("{" + repo_model_name + "}")
