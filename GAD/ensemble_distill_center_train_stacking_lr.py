...
T = 3
alpha = 0.8
lr_list = [2e-6, 3e-6, 4e-6, 2e-5, 3e-5, 4e-5, 2e-4, 3e-4, 4e-4, 2e-3, 3e-3, 4e-3, 2e-2, 3e-2, 4e-2]
lambda_value = 0.75
...
teacher_model_4 = torch.load("./GAD_model/center_model_Bio-renet.pkl", map_location=teacher_device)
