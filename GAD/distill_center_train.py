...
# teacher_model = torch.load("./gad_model.pkl").to('cpu')
...
for epoch in range(epochs):
    ...
    for step, batch in tqdm(enumerate(train_dataloader)):
        ...
        outputs_teacher = teacher_model(batch[0].to(device), token_type_ids=None, attention_mask=(batch[0] > 0).to(device))
    ...
    if best_f1 < avg_val_f1:
        ...
        torch.save(model.state_dict(), './distill_center/distill_center_model.pth')
    print('\n')
