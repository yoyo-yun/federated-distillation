...
teacher_model_1 = torch.load("./GAD_model/center_model_bert.pkl", map_location=teacher_device)
teacher_model_2 = torch.load("./GAD_model/center_model_scibert.pkl", map_location=teacher_device)
teacher_model_3 = torch.load("./GAD_model/center_model_roberta-base.pkl", map_location=teacher_device)
teacher_model_4 = torch.load("./GAD_model/center_model_biobert.pkl", map_location=teacher_device)
teacher_model_5 = torch.load("./GAD_model/center_model_ClinicalBERT.pkl", map_location=teacher_device)

# teacher_model_name_1 = 'albert'
# teacher_model_name_2 = 'scibert'
# teacher_model_name_3 = 'PubMedBERT'
# teacher_model_1 = torch.load("./GAD_model/center_model_albert.pkl", map_location=teacher_device)
# teacher_model_2 = torch.load("./GAD_model/center_model_scibert.pkl", map_location=teacher_device)
# teacher_model_3 = torch.load("./GAD_model/center_model_PubMedBERT.pkl", map_location=teacher_device)
