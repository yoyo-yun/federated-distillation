...
for model_name in fd_mode_name:
    ...
    df0 = pd.read_csv("./shuffleDatasets/data_" + str(file_index) + ".csv")
    df1 = pd.read_csv("./shuffleDatasets/data_" + str(file_index + 1) + ".csv")
    print("==========model name============")
    print("==========" + model_name + "============")
    print("==========train Dataset============")
    print("==========" + str(file_index) + " and " + str(file_index + 1) + "============")
