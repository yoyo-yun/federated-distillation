...
file_index = 0
fd_mode_name = ['emilyalsentzer/Bio_ClinicalBERT']
fd_mode_name_list = ['Bio_ClinicalBERT']
for model_name in fd_mode_name:
    ...
    df0 = pd.read_csv("./shuffleDatasets/data_" + str(0) + ".csv")
    df1 = pd.read_csv("./shuffleDatasets/data_" + str(1) + ".csv")
    print("==========model name============")
    print("==========" + model_name + "============")
    print("==========train Dataset============")
    print("==========" + str(0) + " and " + str(1) + "============")
