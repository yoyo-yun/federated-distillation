...
datasets_test_filename = "i2b2_test.csv"
# F1:83
# model_name = "bert-base-uncased"
model_name = "CNT-UPenn/Bio_ClinicalBERT_for_seizureFreedom_classification"
...
model.classifier = nn.Sequential(nn.Linear(768,246),nn.Linear(246,class_num),nn.Softmax())
...
df0 = pd.read_csv("./" + datasets_filename)
...
# loadData val
pd1 = pd.read_csv("./" + datasets_test_filename)
...
def flat_accuracy(preds, labels):
    ...
    # print("========labels_flat========")
    # print(labels_flat)
    return accuracy_score(labels_flat, pred_flat), precision_score(labels_flat, pred_flat, average='macro'), \
           recall_score(labels_flat, pred_flat, average='macro'), f1_score(labels_flat, pred_flat, average='macro')
